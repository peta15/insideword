 ...
 * 
 * [tooltip, tooltip.slide, tooltip.dynamic, scrollable, scrollable.autoscroll, scrollable.navigator, overlay, overlay.apple, toolbox.history, toolbox.mousewheel]
 * 
 ...
 * 
 *  ****** modified by jgoodall may 2010.  using .live for close binding of overlays.
 *      new: k.live('click',function
 *      old: than k.click(function
 *  ****** modified by jgoodall may 2010.  removed overlays load on click so that we can override externally with our own (using .live)
 *      commented out: d&&d.index(f)==-1&&d.click(function(e){c.load(e);return e.preventDefault()});
 * -----
 * 
 * File generated: Thu May 20 23:51:45 GMT 2010
 */
...
getTrigger:function(){return d},getClosers:function(){return k},isOpened:function(){return m},getConf:function(){return b}});a.each("onBeforeLoad,onStart,onLoad,onBeforeClose,onClose".split(","),function(e,h){a.isFunction(b[h])&&a(c).bind(h,b[h]);c[h]=function(j){a(c).bind(h,j);return c}});k=f.find(b.close||".close");if(!k.length&&!b.close){k=a('<div class="close"></div>');f.prepend(k)}k.live('click',function(e){c.close(e)});b.load&&c.load()}a.tools=a.tools||{version:"1.2.2"};a.tools.overlay={addEffect:function(d,
